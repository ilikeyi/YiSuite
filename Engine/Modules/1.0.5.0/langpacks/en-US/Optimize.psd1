ConvertFrom-StringData -StringData @'
	...
	PaintAI                   = Artificial intelligence features in Paint
	NotepadAI                 = Artificial intelligence features in Notepad

	# Browser
	Browser                   = Browser
	Edge                      = Microsoft Edge browser
	EdgePD                    = Diagnostic data, personalized advertising, search, etc.
	EdgeAds                   = Disable ads, recommended content, and MSN news feed in Microsoft Edge
	EdgeAi                    = Artificial intelligence features in Microsoft Edge

	Spotlight                 = Windows Spotlight desktop background options
	ClickToDo                 = Click to Do
	Copilot                   = Copilot
	DldlcTips                 = Tips and tricks for the lock screen
	MS365Ads                  = Microsoft 365 ads in Settings Home
	OnlineSR                  = Online Speech Recognition
	Start_TrackProgs          = Let Windows improve Start and search results by tracking app launches
	End_Task                  = Enabling the 'End Task' option in the taskbar right click menu
	Drdfnpofe                 = Hiding duplicate removable drive entries from the File Explorer navigation pane
	...
	# System class
	Dgreadiness               = VBS ( Virtualization-Based Security )
