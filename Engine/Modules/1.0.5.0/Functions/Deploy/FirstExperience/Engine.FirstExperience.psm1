...
Function FirstExperience_Setting_UI
{
	...
	$GUIFEOK           = New-Object system.Windows.Forms.Button -Property @{
		...
		add_Click      = {
			...
			write-host "`n  $($lang.DeployCleanup)"
...
#		Desktop_ICON_IE -AllUsers               # Internet Explorer
		...
		<#
			.AI
		#>
#		Recall_AI -Disable              # Disable, Enabled             | $lang.Recall_AI
#		Paint_AI -Disable               # Disable, Enabled             | $lang.Paint_AI
#		Notepad_AI -Disable             # Disable, Enabled             | $lang.NotepadAI

		<#
			.Browser
			.浏览器
		#>
#		ForceRemoveEdge                                                | $lang.Edge
#		Edge_PD -Disable                # Disable, Enabled             | $lang.EdgePD
#		Edge_Ads -Disable               # Disable, Enabled             | $lang.EdgeAds
#		Edge_AI -Disable                # Disable, Enabled             | $lang.EdgeAI
...
#		IPv6_Component -Disable               # Disable, Enabled             | $lang.IPv6Component
		...
		<#
			...
			.资源管理器
		#>
		Drdfnpofe -Disable              # Disable, Enabled             | $lang.DelFoldersduplicate
...
#			Taskbar_Alignment -Leaf          # Leaf, Center                | $lang.TaskbarAlignment
		...
		End_Task -Add                        # Add, Remove                 | $lang.End_Task
		...
		OnlineSR -Disable                        # Disable, Enabled     | $lang.OnlineSR
		Start_TrackProgs -Disable                # Disable, Enabled     | $lang.Start_TrackProgs
