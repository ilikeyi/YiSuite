...
Function Desktop
{
	...
	switch ($Global:IsLang) {
		"zh-CN" {
			$GUIDesktop.Font = New-Object System.Drawing.Font("Microsoft YaHei", 9, [System.Drawing.FontStyle]::Regular)
		}
		Default {
			$GUIDesktop.Font = New-Object System.Drawing.Font("Segoe UI", 9, [System.Drawing.FontStyle]::Regular)
		}
	}
...
Function Desktop_ICON_God_Mode
{
	...
	mkdir "$($DesktopPath)\GodMode.{ED7BA470-8E54-465E-825C-99712043E01C}" -ErrorAction SilentlyContinue | Out-Null
	Write-Host "   $($lang.Done)`n" -ForegroundColor Green
}
