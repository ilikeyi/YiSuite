...
Function Personalise
{
	...
	if ($Add) {
		...
		New-ItemProperty -LiteralPath "HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\CommandStore\shell\$($Global:Author).MainPanel" -Name 'Icon' -Value "$($IconFolder)\Assets\icons\MainPanel.ico" -PropertyType String -force -ErrorAction SilentlyContinue | Out-Null
		...
		New-ItemProperty -LiteralPath "HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\CommandStore\shell\$($Global:Author).Dir" -Name 'Icon' -Value "$($IconFolder)\Assets\icons\Engine.Gift.ico" -PropertyType String -force -ErrorAction SilentlyContinue | Out-Null
		...
		New-ItemProperty -LiteralPath "HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\CommandStore\shell\$($Global:Author).Dir\command" -Name '(default)' -Value "explorer $($Global:UniqueMainFolder)" -PropertyType String -force -ErrorAction SilentlyContinue | Out-Null
		...
		New-ItemProperty -LiteralPath "HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\CommandStore\shell\$($Global:Author).Reg" -Name 'Icon' -Value "$($IconFolder)\Assets\icons\FirstExperience.ico" -PropertyType String -force -ErrorAction SilentlyContinue | Out-Null
		...
		New-ItemProperty -LiteralPath "HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\CommandStore\shell\$($Global:Author).Update" -Name 'Icon' -Value "$($IconFolder)\Assets\icons\update.ico" -PropertyType String -force -ErrorAction SilentlyContinue | Out-Null
		...
		New-ItemProperty -LiteralPath "HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\CommandStore\shell\$($Global:Author).About" -Name 'Icon' -Value "$($IconFolder)\Assets\icons\about.ico" -PropertyType String -force -ErrorAction SilentlyContinue | Out-Null
		...
		New-ItemProperty -LiteralPath "HKLM:\SOFTWARE\Classes\Directory\Background\shell\$($Global:Author)" -Name 'Icon' -Value "$($IconFolder)\Assets\icons\Engine.ico" -PropertyType String -force -ErrorAction SilentlyContinue | Out-Null
