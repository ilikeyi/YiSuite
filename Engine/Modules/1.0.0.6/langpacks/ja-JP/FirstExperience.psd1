ConvertFrom-StringData -StringData @'
	...
	SettingLangAndKeyboard    = システム言語とキーボードを設定します
	...
	PreAppxCleanup            = Appx クリーンアップ メンテナンス タスク
	CleanupOndemandLP         = 未使用のフィーチャーオンデマンド言語パックのクリーンアップを防止する
	CleanupUnusedLP           = 未使用の言語パックのクリーニングを防止する
	Restricted                = Powershell 実行戦略の再開：制限付き
	DiskSearch                = 検索プラン：
