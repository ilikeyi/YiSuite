ConvertFrom-StringData -StringData @'
	...
	PreAppxCleanup            = Appx 정리 유지 관리 작업
	CleanupOndemandLP         = 사용하지 않는 주문형 기능 언어 팩 정리 방지
	CleanupUnusedLP           = 사용하지 않는 언어 팩 정리 방지
	Restricted                = Powershell 실행 전략 재개: 제한됨
	DiskSearch                = 검색 계획:
	...
	LangMul                   = 다국어
	LangSingle                = 단일 언어
	RandomlyWaitSel           = 임의로 선택된 언어를 기다립니다
	RandomlySelResults        = 결과를 임의로 선택합니다
	LanguageInstalled         = 언어 팩이 시스템에 이미 설치되어 있습니다
