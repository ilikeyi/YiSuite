...
$AvailableLanguages = @(
	...
	@{
		...
		Language = @{
			FontsUI                  = "Segoe UI"
			Get                      = "احصل على Yi's Suite عبر الإنترنت"
	...
	@{
		...
		Language = @{
			FontsUI                 = "Segoe UI"
			Get                      = "Nabavite Yi's Suite online"
	...
	@{
		...
		Language = @{
			FontsUI                  = "Segoe UI"
			Get                      = "Získejte Yi's Suite online"
	...
	@{
		...
		Language = @{
			FontsUI                  = "Segoe UI"
			Get                      = "Obtenez Yi's Suite en ligne"
	...
	@{
		...
		Language = @{
			FontsUI                  = "Segoe UI"
			Get                      = "Αποκτήστε το Yi's Suite στο διαδίκτυο"
	...
	@{
		...
		Language = @{
			FontsUI                  = "Segoe UI"
			Get                      = "קבל את Yi's Suite באינטרנט"
	...
	@{
		...
		Language = @{
			FontsUI                  = "Segoe UI"
			Get                      = "Szerezze be a Yi's Suite szolgáltatást online"
	...
	@{
		...
		Language = @{
			FontsUI                  = "Segoe UI"
			Get                      = "Iegūstiet Yi's Suite tiešsaistē"
	...
	@{
		...
		Language = @{
			FontsUI                  = "Segoe UI"
			Get                      = "Gaukite Yi's Suite internetu"
	...
	@{
		...
		Language = @{
			FontsUI                  = "Segoe UI"
			Get                      = "Obtenha Yi's Suite on-line"
	...
	@{
		...
		Language = @{
			FontsUI                  = "Segoe UI"
			Get                      = "Obțineți Yi's Suite online"
	...
	@{
		...
		Language = @{
			FontsUI                  = "Segoe UI"
			Get                      = "Získajte Yi's Suite online"
	...
	@{
		...
		Language = @{
			FontsUI                  = "Segoe UI"
			Get                      = "Pridobite Yi's Suite na spletu"
	...
	@{
		...
		Language = @{
			FontsUI                  = "Segoe UI"
			Get                      = "Obtenga Yi's Suite en línea"
	...
	@{
		...
		Language = @{
			FontsUI                  = "Segoe UI"
			Get                      = "Çevrimiçi edinin Yi's Suite"
	...
	@{
		...
		Language = @{
			FontsUI                  = "Segoe UI"
			Get                      = "Отримайте Yi's Suite онлайн"
	...
	@{
		...
		Language = @{
			FontsUI                  = "Segoe UI"
			Get                      = "Descarga Yi's Suite en liña"
	...
	@{
		...
		Language = @{
			FontsUI                  = "Segoe UI"
			Get                      = "Dapatkan Yi's Suite secara online"
	...
	@{
		...
		Language = @{
			FontsUI                  = "Segoe UI"
			Get                      = "Набавите Yi's Suite на мрежи"
	...
	@{
		...
		Language = @{
			FontsUI                  = "Segoe UI"
			Get                      = "Holen Sie sich Yi's Suite online"
	...
	@{
		...
		Language = @{
			FontsUI                  = "Segoe UI"
			Get                      = "Получите Yi's Suite онлайн"
